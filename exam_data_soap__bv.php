...
// Define page object
$exam_data_Soap_blobview = new cexam_data_Soap_blobview();
$Page =& $exam_data_Soap_blobview;

// Page init processing
$exam_data_Soap_blobview->Page_Init();

// Page main processing
$exam_data_Soap_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cexam_data_Soap_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'exam_data_Soap_blobview';
	...
	//  - open connection
	//
	function cexam_data_Soap_blobview() {
		global $conn;
